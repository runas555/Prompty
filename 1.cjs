...
function main() {
  // Шаг 1: Создание/Обновление нового интерактивного PostModal с тумблером автоперевода
...
`;
  ...
  try {
    ...
    console.log(`[SUCCESS] Создан/обновлен файл PostModal.tsx по пути: ${postModalPath}`);
  } catch (err) {
